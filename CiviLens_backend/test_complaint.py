...
if response.status_code == 200:
    ...
    complaint_response = requests.post('http://127.0.0.1:8000/api/complaints/', json=complaint_data, headers=headers)
    print("Complaint response:", complaint_response.status_code)
    print("Complaint content:", complaint_response.json())
else:
